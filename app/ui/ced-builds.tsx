    ...
    return (
        <div className="relative">
            <button 
                ...
                className="hover:cursor-pointer relative block w-[40px] h-[40px]"
            ...
            {isWorkModelOpen && (
                <div className="fixed inset-0 backdrop-blur-xs flex items-center justify-center z-50" onClick={() => closeWorkModel()}>
                    <div className="bg-white p-6 rounded-lg max-w-md w-[90%] md:w-full border border-gray-400" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="space-y-1 text-xs mb-2">
                            <p className="text-xs">Send an email to <Link className="underline" href="mailto:murairicedric@gmail.com">murairicedric@gmail.com</Link>. Start your subject with [Cédric Builds].</p>
